                                    ...
                                    @foreach ($invoices as $invoice)
                                        <tr class="mb-4">
                                            <td class="px-4 py-2 border">
                                                ...
                                                {{ $invoice->created_at->format('h F, Y') }}
                                            </td>
                                            <td class="px-4 py-2 border">
                                                {{ $invoice->client_name }}
                                                <br />
                                            ...
                                            <td class="px-4 py-2 border">
                                                ...
                                                <br />
                                                <small>
                                                    Due on {{ $invoice->invoice_date->format('h F, Y') }}
                                                </small>
                                            </td>
                                            <td class="px-4 py-2 border">
                                            ...
                                            <td class="px-4 py-2 border">
                                                {{ $invoice->updated_at->format('h F, Y') }}
                                            </td>
                                            <td class="px-4 py-2">
                                                <div class="dropdown relative inline-flex rtl:[--placement:bottom-end]">
                                                    <x-buttons.btn aria-expanded="false" aria-haspopup="menu"
                                                        aria-label="Dropdown" class="border-none rounded-md dropdown-toggle bg-primary/70 hover:bg-primary/90"
                                                    ...
                                                    <ul aria-labelledby="dropdown-default" aria-orientation="vertical"
                                                        class="hidden !text-black bg-white border-[1px] min-w-60 dropdown-menu dropdown-open:opacity-100"
                                                        role="menu">
                                                        {{-- //TODO:If status == sent but not paid --}}
                                                        {{-- Dispatch event, send mailable, add function to do so? --}}
                                                        <li><a class="dropdown-item !text-black" href="#">Send Reminder</a></li>

                                                        <li><a class="dropdown-item !text-black" href="{{ route('invoices.edit', $invoice->invoice_number) }}">Edit Invoice</a></li>
                                                        <li><a class="dropdown-item !text-black" href="#">Preview Invoice</a></li>
                                                        <li><a class="dropdown-item !text-black" href="#">Print Invoice</a></li>
                                                        <li><a class="dropdown-item !text-black" href="#">Download PDF</a></li>
                                                        <li><a class="dropdown-item !text-black" href="#">Cancel Invoice</a></li>
                                                        <li><a class="my-2 text-white bg-red-600 border-none dropdown-item btn hover:bg-red-800" href="#">Delete Invoice</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
