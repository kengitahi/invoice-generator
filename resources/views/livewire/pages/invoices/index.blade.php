        ...
        @if ($invoices->count() > 0)
            <div class="flex justify-between">
                <form wire:submit="findInvoices" class="flex flex-col gap-2 pb-4">
                    ...
                    <x-buttons.btn btn="primary" class="md:w-fit text-lg" type="submit">
                        Search Invoices
                    </x-buttons.btn>
                </form>
                <x-links.link :href="route('invoices.create')"
                    class="text-lg group mt-2 h-fit transition duration-300 ease-in-out hover:border-transparent"
                    type="primary">
        ...
        <div class="p-6 text-gray-900">
            @if (count($invoices) == 0)
                <div>
                    ...
                    <x-links.link :href="route('invoices.create')"
                        class="text-md group transition duration-300 ease-in-out hover:border-transparent"
                        type="primary">
                        Create an Invoice
                        <svg class="size-4 transition duration-300 ease-in-out group-hover:translate-x-2" fill="none"
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="dropdown relative inline-flex rtl:[--placement:bottom-end]">
                                            ...
                                            <ul aria-labelledby="dropdown-default" aria-orientation="vertical"
                                                ...
                                                <li>
                                                    <a class="dropdown-item !text-black" href="#">
                                                        <svg aria-hidden="true" class="size-4 shrink-0" fill="none"
                                                ...
                                                <li>
                                                    <a class="dropdown-item !text-black" href="#">
                                                        <svg class="size-4 shrink-0" fill="none" height="24"
                                                            stroke-linecap="round" stroke-linejoin="round"
