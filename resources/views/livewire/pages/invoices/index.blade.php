                    ...
                    <form class="flex flex-col gap-2 pb-4" wire:submit="findInvoices">
                        <div class="flex flex-col">
                            ...
                            <x-inputs.text class="max-w-md pt-3 pl-2 text-lg w-96" id="SearchTerm" name="SearchTerm"
                                placeholder="Search..." wire:model.live="SearchTerm" required/>
                            <p class="mt-1 text-gray-600 text-md">Enter invoice number, client's name or client's email.
                            </p>
                        </div>
                        <x-buttons.btn btn="primary" class="text-lg md:w-fit" type="submit">
                            Search Invoices
                        </x-buttons.btn>
                    </form>
                    <x-links.link :href="route('invoices.create')"
                        class="mt-2 text-lg transition duration-300 ease-in-out group h-fit hover:border-transparent"
                        type="primary">
