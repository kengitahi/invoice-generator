...
<div class="relative" x-data="{ dropdownOpen: false }">
    ...
    <div @click.away="dropdownOpen=false" class="absolute top-0 z-50 w-56 mt-12 -translate-x-1/2 left-1/2" x-cloak
        ...
        <div class="p-1 mt-1 bg-white border rounded-md shadow-md border-neutral-200/70 text-neutral-700">
            ...
            <div class="h-px my-1 -mx-1 bg-neutral-200"></div>
            <button class="cursor-pointer focus:text-accent-foreground relative flex select-none items-center rounded px-2 py-1.5 text-sm outline-none transition-colors hover:bg-neutral-100 focus:bg-accent data-[disabled]:pointer-events-none data-[disabled]:opacity-50">
                <svg class="w-4 h-4 mr-2" fill="none" height="24" stroke-linecap="round" stroke-linejoin="round"
                    stroke-width="2" stroke="currentColor" viewBox="0 0 24 24" width="24"
                    xmlns="http://www.w3.org/2000/svg">
